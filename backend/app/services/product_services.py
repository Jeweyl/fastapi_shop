...
from app.schemas.products import ProductResponse, ProductListResponse, ProductCreate
...
class ProductService:
    ...
    def get_all_products(self) -> List[ProductResponse]:
        ...
        return ProductListResponse(products_response, total=len(products_response))
    ...
    def get_product_by_category(self, category_id: int) -> ProductResponse:
